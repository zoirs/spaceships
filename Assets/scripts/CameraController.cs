...
public class CameraController : MonoBehaviour {
    ...
    void Update() {
        if (Input.GetKeyDown(KeyCode.Space)) {
            _targetPosition.z = _targetPosition.z * 1.1f;
        }
    ...
    public void go(GameObject o) {
        ...
        float y = transform.position.y + Math.Abs(o.GetComponent<RectTransform>().position.y - bottom.y) - o.GetComponent<CircleCollider2D>().radius * 5f;
